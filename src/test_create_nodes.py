...
from create_nodes import split_nodes_delimiter, extract_markdown_images, extract_markdown_links, split_nodes_image, split_nodes_link, text_to_textnodes
...
class TestTextToTextNodes(unittest.TestCase):
    ...
    def test_text_to_textnodes1(self):
        text = "This is just a long string that should only produce a normal textnode."
        new_nodes = text_to_textnodes(text)
        self.assertListEqual(
            [
            TextNode("This is just a long string that should only produce a normal textnode.", TextType.NORMAL),
            ],
            new_nodes,
        )
